...
near view $MARKET_CONTRACT_ID get_sale '{"nft_contract_token": "'$NFT_CONTRACT_ID'||1:5"}'

near call $MARKET_CONTRACT_ID hack_finish_sale '{"nft_contract_token": "'$NFT_CONTRACT_ID'||1:5"}' --accountId $ALICE
